...
<html lang="en">
    ...
    <body>
        ...
        $thumbPath = empty($thumbPath) ? $defaultPath : '/scms_packet/webroot/uploads/students/thumbnail/' . $thumbPath; //THUMBNAIL_LOCATION4

            ?>


        <div class="institute-title"><img src="/scms_packet/webroot/uploads/school-title.png" alt=""></div>
...
<div class="row" id="signature">
    ...
    <div class="col-md-3 signature">Student's Signature</div>
    <div class="col-md-3 signature">Parent's Signature</div>
</div>
<div class="sp">
